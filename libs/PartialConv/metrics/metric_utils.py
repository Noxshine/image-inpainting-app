...
#                                         batch_gen=None, jit=False, data_loader_kwargs=None, **stats_kwargs):
#     if data_loader_kwargs is None:
#         data_loader_kwargs = dict(pin_memory=True, num_workers=3, prefetch_factor=2)
#
...
# #----------------------------------------------------------------------------
#
# def compute_image_stats_for_generator(opts, rel_lo=0, rel_hi=1, batch_size=64, batch_gen=None, jit=False,
#                                       data_loader_kwargs=None, **stats_kwargs):
#     if data_loader_kwargs is None:
#         data_loader_kwargs = dict(pin_memory=True, num_workers=3, prefetch_factor=2)
#
#     if batch_gen is None:
